  ...
  return (
    <div className="mb-6 rounded-2xl border border-brand-border bg-white p-4 md:p-6 shadow-sm">
      <div className="flex flex-wrap items-center gap-4">
        ...
        {hasStockAdmin && (
          <>
            {/* Show Repository dropdown if no specific outlet is selected */}
            {(!initialFilters.outlet || initialFilters.outlet === "all") && (
              <div className="w-full sm:w-[220px]">
                <Select
            ...
            {/* Show Outlet dropdown if no specific repository is selected */}
            {(!initialFilters.repository || initialFilters.repository === "all") && (
              <div className="w-full sm:w-[220px]">
                <Select
