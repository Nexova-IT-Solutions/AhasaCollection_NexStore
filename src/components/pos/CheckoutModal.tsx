    ...
    try {
      const payload = {
        items: items.map((item) => ({
          ...
          discountName: item.discountName || (item.discountPercent > 0 ? `${item.discountPercent}% off` : null),
          discountValue: item.discountValue || (item.discountPercent > 0 ? item.discountPercent : null),
